...
if (((X - x1) * (YY - Y) - (XX - X) * (Y - y1)) * ((X - x2) * (YY - Y) - (XX - X) * (Y - y2))
    <= 0 and ((x1 - X) * (y2 - y1) - (x2 - x1) * (y1 - Y)) * ((x1 - XX) * (y2 - y1) - (x2 - x1) * (y1 - YY))
    <= 0) or (((X - x1) * (YY - Y) - (XX - X) * (Y - y1)) * ((X - x3) * (YY - Y) - (XX - X) * (Y - y3))
              <= 0 and ((x1 - X) * (y3 - y1) - (x3 - x1) * (y1 - Y)) * ((x1 - XX) * (y3 - y1) - (x3 - x1) * (y1 - YY))
              <= 0) or (((X - x2) * (YY - Y) - (XX - X) * (Y - y2)) * ((X - x3) * (YY - Y) - (XX - X) * (Y - y3))
                        <= 0 and ((x2 - X) * (y3 - y2) - (x3 - x2) * (y2 - Y)) * (
                                (x2 - XX) * (y3 - y2) - (x3 - x2) * (y2 - YY)) <= 0):
